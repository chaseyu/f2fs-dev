...
bool f2fs_has_enough_room(struct inode *dir, struct f2fs_cached_block *entry,
...
int f2fs_wait_on_node_caches_writeback(struct f2fs_sb_info *sbi,
					unsigned int seq_id);
int f2fs_write_node_caches(struct f2fs_sb_info *sbi, bool sync);
...
void f2fs_write_meta_caches(struct f2fs_sb_info *sbi, bool sync);
...
struct folio *f2fs_get_new_data_folio(struct inode *inode,
			struct f2fs_cached_block *entry, pgoff_t index, bool new_i_size);
...
void f2fs_delete_inline_entry(struct f2fs_dir_entry *dentry,
		struct f2fs_cached_block *entry, struct inode *dir,
		struct inode *inode);
 ...
 * extent_cache.c
 */
bool sanity_check_extent_cache(struct inode *inode, struct f2fs_cached_block *entry);
...
void f2fs_init_read_extent_tree(struct inode *inode, struct f2fs_cached_block *entry);
