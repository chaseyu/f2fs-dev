...
static int f2fs_move_rehashed_dirents(struct inode *dir, struct f2fs_cached_block *ientry,
 							void *inline_dentry)
{
	void *backup_dentry;
	int err;
...
static int do_convert_inline_dir(struct inode *dir, struct f2fs_cached_block *ientry,
 							void *inline_dentry)
{
